...
{
    public class LinuxVirtualMachine : AzureResource
    {
        public static string AzureType = "Microsoft.Compute/virtualMachines";
        public static string ApiVersion = "2020-06-01";
        public static string TerraformType = "azurerm_linux_virtual_machine";

        // TODO: do

        public static new AzureResource FromJsonElement(JsonElement element)
        {
            LinuxVirtualMachine resource = new LinuxVirtualMachine();
